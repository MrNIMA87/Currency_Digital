...
import 'package:flutter_application_1/UI/UI%20Helper/ShimmerMarketView.dart';
...
class Most_purchased extends StatefulWidget {
  const Most_purchased({super.key});

  @override
  State<Most_purchased> createState() => _Most_purchasedState();
}

class _Most_purchasedState extends State<Most_purchased> {
  late Timer timer;
